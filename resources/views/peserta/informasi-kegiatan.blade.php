@extends('layouts.app')
@section('judul', 'Informasi Kegiatan')

@section('isi')
<p class="text-sm text-slate-500">Telusuri kegiatan yang tersedia dan daftar langsung dari sini.</p>

<form method="GET" class="card card-pad mt-4 grid gap-3 sm:grid-cols-[2fr_1fr_auto]">
    <div>
...
<div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    @forelse ($kegiatan as $k)
        @include('publik.partials.kartu-kegiatan', ['k' => $k, 'rute' => 'peserta.informasi-kegiatan.show'])
    @empty
